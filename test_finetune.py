...
x_train, y_train = load_data('/imatge/jmorera/PSPNet-Keras-tensorflow/train.txt', 3000)
x_test, y_test = load_data('/imatge/jmorera/PSPNet-Keras-tensorflow/val.txt', 800)
